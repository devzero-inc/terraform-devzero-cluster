...
| <a name="input_chart_name"></a> [chart\_name](#input\_chart\_name) | Helm chart name | `string` | `"dakr-operator"` | no |
...
| <a name="input_chart_version"></a> [chart\_version](#input\_chart\_version) | Helm chart version | `string` | `"0.1.9"` | no |
...
| <a name="input_namespace"></a> [namespace](#input\_namespace) | Kubernetes namespace to install the chart in | `string` | `"devzero"` | no |
| <a name="input_release_name"></a> [release\_name](#input\_release\_name) | Helm release name | `string` | `"devzero-operator"` | no |
